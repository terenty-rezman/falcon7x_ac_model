...
-- NEW
defineProperty("ftf",globalPropertyi("sim/cockpit2/fuel/fuel_tank_transfer_from"))--
...
if get(bt1f3) == 1 then
set(bt1f2,0);set(bt2f1,0);set(bt2f3,0);set(bt3f1,0);set(bt3f2,0)
set(ftf,3)
set(ftt,1)

elseif get(bt1f2) == 1 then
set(bt1f3,0);set(bt2f1,0);set(bt2f3,0);set(bt3f1,0);set(bt3f2,0)
set(ftf,2)
set(ftt,1)

elseif get(bt2f1) == 1 then
set(bt1f3,0);set(bt1f2,0);set(bt2f3,0);set(bt3f1,0);set(bt3f2,0)
set(ftf,1)
set(ftt,2)

elseif get(bt2f3) == 1 then
set(bt1f3,0);set(bt1f2,0);set(bt2f1,0);set(bt3f1,0);set(bt3f2,0)
set(ftf,3)
set(ftt,2)

elseif get(bt3f1) == 1 then
set(bt1f3,0);set(bt1f2,0);set(bt2f1,0);set(bt2f3,0);set(bt3f2,0)
set(ftf,1)
set(ftt,3)

elseif get(bt3f2) == 1 then
set(bt1f3,0);set(bt1f2,0);set(bt2f1,0);set(bt2f3,0);set(bt3f1,0)
set(ftf,2)
set(ftt,3)
end
if get(bk13) == 1  then --

	if get(m_fuel3) > (get(m_fuel1)*1.005) or get(m_fuel1) > (get(m_fuel3)*1.005)  then -- 
...
local ppax = paxp - 670  -- refernce 1pax à 170lb + 500lb cargo

if vpresel <= 0.80 then
pfuelpax =ppax/990*((0.0000065015*distance^2)+(0.1058871472*distance)-20.7)
...
pfuelpax =ppax/990*((apax*distance^2)+(bpax*distance)-cpax)
end
...
if get(bt1f3) == 1 or get(bt1f2) == 1 or  get(bt2f1) == 1 or get(bt2f3) == 1 or get(bt3f1) == 1 or get(bt3f2) == 1 or get(bk13) == 1 then
fueltransfer()
else
set(ftf,0)
set(ftt,0)
...
set(emrglightb,1)
else set(emrglightb,0)
end
if get(FireSOV0) == 1 then
set(sova1, 1)
end
if get(FireSOV1) == 1 then
set(sovb2, 1); set(sovc2, 1)
end
if get(FireSOV2) == 1 then 
set(sovb3, 1); set(sova3, 1)
end
...
if get(sovc2) == 1 then -- si moteur arrete ou sov activé, pr = 0
set(hyd3, 1) -- set pr dans systeme hyd3
else
set(hyd3,valpydM2)
end
if (N1droit < 15 and N1gauche < 15 )or ( get(sova1) == 1 and get(sova3) == 1 )or (N1droit < 15 and get(sova1) == 1) or (N1gauche < 15 and get(sova3) == 1) then -- s
flagM = 1
else flagM = 0
end
...
if  (N1central > 15 and get(sovb2) == 0) or (N1droit > 15 and get(sovb3) == 0) or hyd == 0 or hyd == 1 then
...
if (get(sovb2) == 1 and get(sovb3) == 1 and hyd == 1 or hyd == 2) or ( get(sovb2) == 1 and  N1droit < 15  and hyd == 1 or hyd == 2) or  (get(sovb3) == 1 and  N1central < 15  and hyd == 1 or hyd == 2) then -- s
...
if( N1central < 15 and get(sovb3) == 1 and hyd == 0) or (N1droit < 15 and get(sovb2) == 1 and hyd == 0) or (N1central < 15 and N1droit < 15 and hyd == 0) or (get(sovb2) == 1 and get(sovb3) == 1 and hyd == 0) then
...
(get(initfuel0) == 0 and get(xbp1) == 1 and get(initfuel2) == 0) or
 (get(initfuel0) == 0 and get(xbp0) == 1 and get(initfuel1) == 0) or get(FireSOV0) == 1 then
	set(mix0, 0)					
	else set(mix0, 1)	
	end		
	if (get(initfuel1) == 0 and get(xbp0) == 0 and get(xbp2) == 0) or (get(initfuel1) == 0 and get(xbp0) == 1 and get(initfuel0) == 0) or (get(initfuel1) == 0 and get(xbp2) == 1 and get(initfuel2) == 0) or get(FireSOV1) == 1 then
	set(mix1, 0)		 
	else set(mix1, 1)			
	end			
	if (get(initfuel2) == 0 and get(xbp1) == 0 and get(xbp2) == 0) or (get(initfuel2) == 0 and get(xbp1) == 1 and get(initfuel0) == 0) or (get(initfuel2) == 0 and get(xbp2) == 1 and get(initfuel1) == 0) or get(FireSOV2) == 1 then
	set(mix2, 0)		
	else set(mix2, 1)
	end	
...
selcruisespeed() 
PAX()
local ZFW = 33200 + (get(payload)*2.2046)-- je retranche 1072lb à 34272
...
local ptempfuel = (0.0003818684*distance^2)+(2.561714*distance)+4449
local ptempo1 =ZFW + ptempfuel-- zéro fuel weight + reservenbaa + fuel trip
local distmonte = (-0.0000000723*ptempo1^2)+(0.010410686*ptempo1)-226.19
...
fuelcruise = (0.00022084 * cruisedist ^ 2) + (3.09071725 * cruisedist) + 16
end
if distance > 2000 and distance <= 4000 then
fuelcruise = (0.0003187 * cruisedist ^ 2) + (2.8244443 * cruisedist) + 150
end
if distance > 4000 then
fuelcruise = (0.00027098 * cruisedist ^ 2) + (2.9649112 * cruisedist) + 390
end
distcruise = distance - distmonte - 160   
if vpresel >= 0.75 and vpresel <= 0.8 then
local acr = (0.00967022*vpresel^2)-(0.014973343*vpresel)+0.0060414442
local bcr = (30.67927942*vpresel^2)-(47.277374419*vpresel)+21.2658229979
local ccr = (4374*vpresel^2)-(6675.3*vpresel)+2686.1
fuelcruises = (acr*distcruise^2)+(bcr*distcruise)+ccr
end
if vpresel == 0.81 then
fuelcruises = (0.0002578357*distcruise^2)+(3.0925877126*distcruise)+151.956
elseif vpresel == 0.82 then
fuelcruises = (0.0002641606*distcruise^2)+(3.1065663362*distcruise)+158.781
elseif vpresel == 0.83 then
fuelcruises = (0.0002744741*distcruise^2)+(3.1364673276*distcruise)+165.975
elseif vpresel == 0.84 then
fuelcruises = (0.0002778217*distcruise^2)+(3.2147568436*distcruise)+155.14
elseif vpresel == 0.85 then
fuelcruises = (0.0003008366*distcruise^2)+(3.2458341227*distcruise)+172,32
end
if vpresel > 0.85 then
local acrb = (0.0095591667*vpresel^2)-(0.014741275*vpresel)+0.0059244224
local bcrb = (82.6080205*vpresel^2)-(133.313134685*vpresel)+56.8777
...
set(fueltrip, reservefuel+fuel_to_alt+fuelcruises+pfuelpax+down_et_taxi)
...
if p1 >=67000 then set(cruisealtopt,35000)
elseif p1 >=63000 and p1< 67000 then set(cruisealtopt,37000)
elseif p1 >=60000 and p1< 63000 then set(cruisealtopt,39000)
elseif p1 >=55000 and p1<60000 then set(cruisealtopt,41000)
elseif p1 >=50000 and p1<55000 then set(cruisealtopt,43000)
elseif p1 >=45000 and p1<50000 then set(cruisealtopt,45000)
elseif p1<45000 then set(cruisealtopt,47000)
end
if distance <= 400 then set(cruisealtopt,37000) end 
if get(speedinmach) >= .7 then
po=p+((get(speedinmach)*150000)-120000)
if po >=67000 then set(cropt,35000)
elseif po >=63000 and po< 67000 then set(cropt,37000)
elseif po >=60000 and po< 63000 then set(cropt,39000)
elseif po >=55000 and po<60000 then set(cropt,41000)
elseif po >=50000 and po<55000 then set(cropt,43000)
elseif po >=45000 and po<50000 then set(cropt,45000)
elseif po<45000 then set(cropt,47000)
end
end
if get(apu) == 1 then 
set(fpump1,1)
