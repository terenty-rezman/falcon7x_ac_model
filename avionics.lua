...
-- Z
z_eng1_oil_press_override = createGlobalPropertyi("sim/custom/7x/z_eng1_oil_press_override", 0)
z_eng1_oil_press = createGlobalPropertyf("sim/custom/7x/z_eng1_oil_press", 0)
z_original_eng1_oil_press = globalPropertyf("sim/cockpit2/engine/indicators/oil_pressure_psi")
-- Z
...
defineProperty("spot1", globalPropertyf("sim/cockpit2/switches/panel_brightness_ratio[0]"));
defineProperty("spot2", globalPropertyf("sim/cockpit2/switches/panel_brightness_ratio[1]"));
defineProperty("spot3", globalPropertyf("sim/cockpit2/switches/panel_brightness_ratio[2]"));
defineProperty("lumpanel", globalPropertyf("sim/cockpit2/switches/instrument_brightness_ratio[0]"));
defineProperty("spoti", globalPropertyf("sim/cockpit2/switches/instrument_brightness_ratio[1]"));
defineProperty("spothead", globalPropertyf("sim/cockpit2/switches/instrument_brightness_ratio[4]"));--##### 
defineProperty("lumBU", globalPropertyf("sim/cockpit2/switches/instrument_brightness_ratio[3]"));
createProp("sim/custom/7x/paxlum", "int")
defineProperty("paxlum", globalPropertyi("sim/custom/7x/paxlum"))
defineProperty("flash",globalPropertyi("sim/flightmodel2/lights/strobe_flash_now"));
defineProperty("llsd",globalPropertyf("sim/cockpit2/switches/landing_lights_switch[1]"));
defineProperty("lld",globalPropertyf("sim/weapons/warhead_type[10]"))
defineProperty("llsg",globalPropertyf("sim/cockpit2/switches/landing_lights_switch[2]"));
...
defineProperty("bleedAPU",globalPropertyi("sim/cockpit2/pressurization/actuators/bleed_air_mode"))
...
defineProperty("indicN10", globalPropertyf("sim/cockpit2/engine/indicators/N1_percent[0]"))
defineProperty("indicN11", globalPropertyf("sim/cockpit2/engine/indicators/N1_percent[1]"))
defineProperty("indicN12", globalPropertyf("sim/cockpit2/engine/indicators/N1_percent[2]"))
defineProperty("starteng",globalPropertyi("sim/weapons/warhead_type[3]"))-- bouton de start engine
defineProperty("starteng1",globalPropertyi("sim/cockpit2/engine/actuators/ignition_key[0]"))
defineProperty("starteng2",globalPropertyi("sim/cockpit2/engine/actuators/ignition_key[1]"))
defineProperty("starteng3",globalPropertyi("sim/cockpit2/engine/actuators/ignition_key[2]"))
...
defineProperty("initfuel0", globalPropertyi("sim/cockpit2/fuel/fuel_tank_pump_on[0]"));
defineProperty("initfuel1", globalPropertyi("sim/cockpit2/fuel/fuel_tank_pump_on[1]"));
defineProperty("initfuel2", globalPropertyi("sim/cockpit2/fuel/fuel_tank_pump_on[2]"));
defineProperty("apun1", globalPropertyf("sim/cockpit2/electrical/APU_N1_percent"));
defineProperty("apu", globalPropertyi("sim/cockpit2/electrical/APU_generator_on"));
defineProperty("apurun", globalPropertyi("sim/cockpit2/electrical/APU_starter_switch"));
defineProperty("apuON", globalPropertyi("sim/cockpit2/electrical/APU_running"))
defineProperty("dump", globalPropertyf("sim/cockpit2/pressurization/actuators/dump_to_altitude_on"));
...
defineProperty("AIeng2", globalPropertyi("sim/cockpit2/ice/ice_inlet_heat_on_per_engine[1]"));
...
defineProperty("heatwind", globalPropertyi("sim/cockpit2/ice/ice_window_heat_on"));
defineProperty("AIAOAcop", globalPropertyi("sim/cockpit2/ice/ice_AOA_heat_on_copilot"));
defineProperty("icedetect", globalPropertyi("sim/cockpit/warnings/annunciators/ice"));
...
defineProperty("autobrak", globalPropertyf("sim/cockpit2/controls/speedbrake_ratio"));
...
defineProperty("hydratio2", globalPropertyf("sim/operation/failures/rel_hydpmp2"))
defineProperty("hydratio3", globalPropertyf("sim/operation/failures/rel_hydpmp3"))
defineProperty("gearfail", globalPropertyf("sim/cockpit2/controls/gear_handle_down"))
defineProperty("hyd1", globalPropertyf("sim/cockpit2/hydraulics/indicators/hydraulic_pressure_1"));-- systeme A
defineProperty("hyd2", globalPropertyf("sim/cockpit2/hydraulics/indicators/hydraulic_pressure_2"));-- systeme B
...
defineProperty("buhydro", globalPropertyf("sim/cockpit2/switches/electric_hydraulic_pump_on"));-- OFF / ON
...
defineProperty("flap0", globalPropertyi("sim/flightmodel2/controls/flap_handle_deploy_ratio"));-- ########### TEST pour FLAP N/A
...
defineProperty("emrglightb", globalPropertyi("sim/cockpit2/switches/generic_lights_switch[0]"));
defineProperty("bat", globalPropertyi("sim/cockpit2/electrical/battery_on[0]"));
defineProperty("batt0", globalPropertyi("sim/cockpit/electrical/battery_array_on[0]"));
defineProperty("batt1", globalPropertyi("sim/cockpit/electrical/battery_array_on[1]"));
defineProperty("inverter", globalPropertyi("sim/cockpit2/electrical/inverter_on"));
defineProperty("avionic", globalPropertyi("sim/cockpit2/switches/avionics_power_on"));
...
defineProperty("altlimit", globalPropertyf("sim/cockpit2/gauges/indicators/radio_altimeter_height_ft_pilot"));
defineProperty("m_total", globalPropertyf("sim/flightmodel/weight/m_total"));
defineProperty("flapmax", globalPropertyf("sim/flightmodel2/controls/flap_handle_deploy_ratio"));
defineProperty("flapdeg", globalPropertyf("sim/flightmodel2/wing/flap1_deg[1]"))
defineProperty("alttod", globalPropertyf("sim/cockpit2/gauges/indicators/altitude_ft_pilot"))
defineProperty("airspeed", globalPropertyf("sim/cockpit2/gauges/indicators/airspeed_kts_pilot"))
defineProperty("airspeedAP", globalPropertyf("sim/cockpit2/autopilot/airspeed_dial_kts_mach"))
defineProperty("groundspd", globalPropertyf("sim/flightmodel/position/groundspeed"))
defineProperty("hdgpa", globalPropertyf("sim/cockpit2/autopilot/heading_dial_deg_mag_pilot")) --#### pour mon test de guidage heading avec PA
defineProperty("direction", globalPropertyf("sim/cockpit2/gauges/indicators/heading_electric_deg_mag_pilot"));
...
defineProperty("accelere", globalPropertyf("sim/cockpit2/gauges/indicators/airspeed_acceleration_kts_sec_pilot"))
createProp("sim/custom/7x/accelereb", "float")
defineProperty("accelereb", globalPropertyf("sim/custom/7x/accelereb"))
defineProperty("pitchdeg", globalPropertyf("sim/cockpit2/gauges/indicators/pitch_AHARS_deg_pilot"))
defineProperty("angleattack", globalPropertyf("sim/flightmodel2/misc/AoA_angle_degrees"))-- autre dataref a essayer sim/flightmodel/position/alpha
...
defineProperty("actualvvi", globalPropertyf("sim/cockpit2/gauges/indicators/vvi_fpm_pilot"))
defineProperty("requetevvi", globalPropertyf("sim/cockpit2/autopilot/vvi_dial_fpm"))
...
defineProperty("pitchdir", globalPropertyf("sim/cockpit2/autopilot/flight_director_pitch_deg"))
defineProperty("pitchdirb", globalPropertyf("sim/cockpit2/autopilot/sync_hold_pitch_deg"))
defineProperty("rolldir", globalPropertyf("sim/cockpit2/autopilot/flight_director_roll_deg"))
defineProperty("roll", globalPropertyf("sim/cockpit2/gauges/indicators/roll_AHARS_deg_copilot"))
defineProperty("dialaltpa", globalPropertyf("sim/cockpit2/autopilot/altitude_dial_ft"))
defineProperty("paaltholdb", globalPropertyi("sim/cockpit2/autopilot/altitude_hold_status"))
defineProperty("paalthold", globalPropertyf("sim/cockpit2/autopilot/altitude_hold_ft"))
...
defineProperty("xpflydir", globalPropertyi("sim/cockpit2/autopilot/flight_director_mode")) -- pour set � 1 au d�part et minimum
createProp("sim/custom/xap/sendv", "int")
defineProperty("sendv", globalPropertyi("sim/custom/xap/sendv"))-- flag d'affichage EFIS AP RF
defineProperty("fuel_total", globalPropertyf("sim/flightmodel/weight/m_fuel_total"))
...
defineProperty("dist_destination", globalPropertyf("sim/custom/xap/dist_destination"))
...
defineProperty("backcourse", globalPropertyi("sim/cockpit/autopilot/backcourse_on"))
...
defineProperty("longactuel", globalPropertyf("sim/flightmodel/position/longitude"))
defineProperty("varcapmagnet", globalPropertyf("sim/flightmodel/position/magnetic_variation"))  --##### variation magn�tique sue le globe 
createProp("sim/custom/7x/rwyvisu", "int")-- heading de la piste
defineProperty("rwyvisu", globalPropertyi("sim/custom/7x/rwyvisu"))
defineProperty("nav1", globalPropertyf("sim/cockpit2/radios/actuators/nav1_frequency_hz"))
defineProperty("com1", globalPropertyf("sim/cockpit2/radios/actuators/com1_frequency_hz"))
defineProperty("com2", globalPropertyf("sim/cockpit2/radios/actuators/com2_frequency_hz"))
defineProperty("com1stby", globalPropertyf("sim/cockpit2/radios/actuators/com1_standby_frequency_hz"))
defineProperty("com2stby", globalPropertyf("sim/cockpit2/radios/actuators/com2_standby_frequency_hz"))
...
defineProperty("reecriture", globalPropertys("sim/custom/7x/reecriture", "string"))--perso
...
defineProperty("teststring114", globalPropertys("sim/custom/7x/teststring114", "string"))
...
defineProperty("decollage", globalPropertys("sim/custom/xap/decollage", "string"))--perso
...
defineProperty("machsw", globalPropertyf("sim/cockpit2/autopilot/airspeed_is_mach"));
...
defineProperty("autothrottle", globalPropertyi("sim/cockpit2/autopilot/autothrottle_on"))
